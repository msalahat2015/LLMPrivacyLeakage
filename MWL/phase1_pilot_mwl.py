...
# CONFIGURATION
# =====================================================
BASE_DIR = "/rep/msalahat/COMP9323-ST-LLMs/MWL01/Phase1"
...
LOG_FILE = os.path.join(BASE_DIR, "phase1_log.json")
...
print("[OK] Phase 1 completed. Log saved at:", LOG_FILE)
